...
| [saved-planning-locations](./2026-09-11-saved-planning-locations-design.md) | **~90%** — saved places, active selector, map editor, planning TZ + banner clock, per-place×sport favorites, GPS snap, cron origin; far-from-all GPS prompt still nice-to-have |

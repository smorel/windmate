...
const WindmateCopy = {
  ...
  map: {
    ...
    discoveryAdded: (n) =>
      n === 1 ? 'Found 1 new launch spot in this area' : `Found ${n} new launch spots in this area`,
  ...
  spotIntel: {
    ...
    intelLoading: 'Loading local intel…',
    intelPending: 'Gathering spot intel in the background — check back in a minute.',
    intelUnavailable:
      'Spot intel is temporarily unavailable (API quota or slow response). Forecast and map data still work — try again later.',
    dayHeadline: 'Today at the spot',
    sectionLaunch: 'Launch & depth',
    sectionAccess: 'Access & hours',
    sectionParking: 'Parking',
    sectionWater: 'Water quality & hazards',
    sectionLive: 'Live cam & wind graph',
    sectionCommunity: 'Riders say',
    sectionWind: 'Wind reference',
    levelBadge: (level) => (level === 'caution' ? 'Caution' : level === 'closed' ? 'Closed' : ''),
    sourceTitle: 'Source',
    sourceHowWeKnow: 'How we know this',
    sourceOpen: 'Open source',
    sourceUnverified: 'Low confidence — verify before you go.',
    sourceMissing: "No source on file yet — we're still collecting intel.",
    sourceUpdated: (label) => `Updated ${label}`,
    sourceKind: {
      manual: 'Curated',
